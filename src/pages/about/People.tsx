...
const BOARD: Leader[] = [
  ...
  },
  {
    name: 'Alex Midrigan',
    role: 'Board Member',
    photo: '/team/alex-midrigan.png',
    bio: [
      'Originally from Moldova, Alex Midrigan has served in church leadership and music ministry for many years. Professionally, he is a Senior Network Administrator whose expertise in technology supports the work of Central Asia Mission. Alex and his wife, Ariza, have five children and continue to serve faithfully in both church and ministry.',
    ],
  },
  {
    name: 'Mirzabek Dosov',
