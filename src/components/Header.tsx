    ...
    >
      <div className="container-page flex items-center justify-between">
        <Link to="/" className="flex items-center gap-3 group" aria-label="Central Asia Mission home">
          <div
            className="w-12 h-12 rounded-lg bg-teal-800 flex items-center justify-center shadow-sm transition-transform group-hover:scale-105"
            aria-hidden
          >
            <span className="font-serif text-base font-bold tracking-wider text-sand-50">CAM</span>
          </div>
          <span
